<div align="center">
  ...
  <!-- Badges -->
  <p>
    <a href="https://kasim-travel-blog.vercel.app" target="_blank">
      <img src="https://img.shields.io/badge/Live_Website-Deployed-success?style=for-the-badge&logo=vercel" alt="Live Status" />
    </a>
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/kasimshah19/KASIM-TRAVEL-BLOG.git
   ```

2. **Navigate to the core directory:**
   ```bash
   cd KASIM-TRAVEL-BLOG
   ```
...
<div align="center">
  <h3>Developed with ❤️ by <a href="https://github.com/kasimshah19">Kasim Shah</a></h3>
